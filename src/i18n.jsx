...
const messages = {
  zh: {
    ...
    originalSource: '查看原始来源', officialReference: '官方课程/文档', selectedParts: '本节选看', loadPlayer: '点击加载 {platform} 播放器',
    ...
    domesticOriginal: '国内模式 · 原始来源', noDomesticEmbed: '本节暂未找到可稳定嵌入的国内视频。请使用所列课程或文档；正文与实验保持完整。',
  ...
  en: {
    ...
    originalSource: 'View original source', officialReference: 'Official course/docs', selectedParts: 'Selected segments', loadPlayer: 'Load {platform} player',
    ...
    domesticOriginal: 'China · Original source', noDomesticEmbed: 'No stable embeddable China-region video is available for this lesson. Continue with the listed course or documentation; the reading and lab remain complete.',
