...
export function getHomeSeo(locale = 'zh', trackId = 'llm') {
  ...
  return {
    ...
    description: isWorld
      ...
      : (isZh ? '80节系统课程，从Python先修、Token、反向传播和Transformer，到推理模型、训练、对齐、部署、Agent与Kimi K3系统审计。' : 'An 80-lesson path from Python prerequisites, tokens, backpropagation, and Transformers to reasoning models, training, post-training, inference, agents, and a Kimi K3 system audit.'),
