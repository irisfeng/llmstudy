...
- 双学习路径：LLM 9 个阶段、76 节；World Models 5 个阶段、12 节；进度分别计算
- 中 / EN 整站切换：导航、88 节课程数据、学习页、实验、项目、资料库与账户流程均支持双语
- 51 节课程配有视频研讨：国内模式全部使用 B站；国际模式使用 YouTube 或官方课程、论文、代码仓库，不再回落到 B站
- 长课程精确映射到对应分P；无法合法嵌入的国际材料明确展示官方原始入口
- 88 节课程均有独立双语 URL，并可进入完整学习页：目标、直觉、机制、实践、自测、笔记与掌握门
- 首页与 88 节课程均可生成微信分享卡片，右下角附课程深链二维码，并保留渠道归因参数
