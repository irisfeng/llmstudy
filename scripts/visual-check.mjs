...
console.log(JSON.stringify({ errors, title: await page.title(), searchResults, curriculumVideoBadges, studyTitle, nextTitle, objectiveCount, sectionCount, lessonHash, workedReveal, quizCorrect, lightTheme, gradientAfterRun, mediaTitle, mediaDeferred, chinaDirect, sourceBadge, mediaParts, selectedPart, partExternal, completedRows, progressLabel, mobileMenuOpen, mobileMediaParts, mobileCurriculumWidth, mobileStudyWidth }, null, 2))
await browser.close()
