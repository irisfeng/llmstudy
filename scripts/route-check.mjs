...
await mobile.goto(`${baseUrl}${lessonPath('2.7', 'zh')}`, { waitUntil: 'domcontentloaded' })
...
console.log(JSON.stringify({ direct: zhPath, legacy: lessonPath('1.3', 'zh'), mobile: lessonPath('2.7', 'zh'), mobileWidth, errors, failures }, null, 2))
