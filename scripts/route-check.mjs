...
await mobile.goto(`${baseUrl}${lessonPath('6.6', 'zh')}`, { waitUntil: 'domcontentloaded' })
...
console.log(JSON.stringify({ direct: zhPath, legacy: lessonPath('1.3', 'zh'), mobile: lessonPath('6.6', 'zh'), mobileWidth, errors, failures }, null, 2))
