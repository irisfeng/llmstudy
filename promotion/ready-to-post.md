...
标题：做了一个免费、开源的 88 节 AI 系统课，想听听大家对课程结构的意见
...
目前有 88 节课，每节尽量包含：要解决的问题、机制拆解、最小实验、自测和掌握门。16 节核心课另外做了可以直接引用的答案、边界条件和一手来源。游客不登录也能学习，进度先保存在本机。
...
把自己学习 AI 系统的路线做成了一个免费网站：88 节中英双语课，包含 LLM 与 World Models 两条独立路线。不是“收藏以后看”，每节都有实践、自测和掌握门。现在最需要的不是点赞，而是认真学习后的纠错和建议。
